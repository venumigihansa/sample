...
- Incident: `inc-hotel-live-ed038dc4d7`
- Base branch: `main`
...
## Root Cause
A test injected an InjectedFailure to simulate a broken hotel search path, causing the search_hotels_tool call to error out.
