...
- Incident: `inc-hotel-live-2f8367588b`
- Base branch: `main`
...
## Root Cause
The hotel-booking-agent service attempted to invoke a downstream tool but the tool call failed due to a missing or misconfigured dependency, resulting in a tool_call_error event.
