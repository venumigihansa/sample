...
- Incident: `inc-hotel-live-f46c49ffcf`
- Base branch: `main`
...
## Root Cause
The hotel-booking-agent invoked the search_hotels_tool, which timed out because the downstream hotel search service was overloaded or unresponsive during peak traffic.
